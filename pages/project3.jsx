        ...
        <div className="w-full">
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
                <div className="col-span-4">
                    ...
                    <h2>Overview</h2>
                    <p>
                        This project is 2 in 1 for me: firstly, the practical improvement of skills in working with Next.js
                        and SendGrid, as well as the creation of my own portfolio. The project is built using Next.js,
                        Tailwind, SendGrid.
                    </p>
                    <a
