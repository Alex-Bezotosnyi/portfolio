        ...
        <div className="w-full">
            <div className="w-screen h-[60vh] relative">
                ...
                <div
                    ...
                    <h3>Next.js | Tailwind | Nodemailer</h3>
                </div>
            </div>
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
                <div className="col-span-4">
                    ...
                    <h2>Overview</h2>
                    <p>
                        This project is 2 in 1 for me: firstly, the practical improvement of skills in working with Next
                        and Node, as well as the creation of my own portfolio. The project is built using Next.js,
                        Tailwind, Nodemailer.
                    </p>
                    <a
                ...
                <div
                    className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4 dark:shadow-gray-600 shadow-md">
                    <div className="p-4">
