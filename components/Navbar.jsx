    ...
    return (
        ...
        >
            <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
                <Link href="/">
                    <img src={dark ? LogoDarkIMG.src : LogoIMG.src}
                         alt="Portfolio"
                         width="125"
                         height="50"
                    />
                ...
                <div
                    ...
                    <div>
                        <div className="flex w-full items-center justify-between">
                            ...
                            <div
                                className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer dark:bg-gray-800 shadow-gray-800"
                                onClick={handleNav}>
                                <AiOutlineClose/>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col py-4">
                        <ul className="uppercase">
                            ...
                            <Link href="/">
                                <li onClick={() => setNav(false)} className="py-4 text-sm dark:text-gray-100">
                                    Home
                                </li>
                            </Link>
                            <Link href="/#about">
